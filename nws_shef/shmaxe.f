...
C
C  ***********************************************************
C  ****************   OVERRIDE ERROR NUMBER - HARDWIRE TO 10000
C  ************************************************************
...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob5/rfc/ofs/src/shefpars_driv/RCS/shmaxe.f,v $
     . $',                                                             '
...
C
      ...
      DATA       INITZ,KHFIND,NUMBR / 0, '**', 10000 /
