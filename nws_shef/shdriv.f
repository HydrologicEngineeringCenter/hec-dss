...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob5/rfc/ofs/src/shefpars_driv/RCS/shdriv.f,v $
     . $',                                                             '
     .$Id: shdriv.f,v 1.4 1999/07/07 14:12:16 page Exp $
     . $' /
C    ===================================================================
C
...
C                   Check for validity of unit numbers
        ...
        IF (LUNE.EQ.LUNO .OR. LUNC.EQ.LUNO) KFLAG = 1
