...
C  =====================================================================
      ...
      INTEGER        NY,NM,ND,NH,NN,NS,LNULL,ITMSER,IERR
...
c    .$Source: /APN/ofs/src/shefpars_driv/RCS/shdece.f,v $
c    . $',                                                             '
c    .$Id: shdece.f,v 1.4 2000/03/14 $
c    . $' /
C    ===================================================================
C
...
c             ierr is used to set the time interval code used in        aem
c             routine shout.f                                           aem
              ierr=(iunit-1)*1000+intval                                aem
c                                                                       aem
