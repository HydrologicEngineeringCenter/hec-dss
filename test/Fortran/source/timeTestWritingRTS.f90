    SUBROUTINE timeTestWritingRTS(ifltabFrom, ifltabTo, pathsFileName, messageUnit, status)
!
...
!
      ...
      integer ierr, npath, count
      integer nvals, i, iofset, mills 


!
  !    WRITE(messageUnit, *)'Begin timeTestWritingRTS'
...
!
 ...
 820        Format('timeTestWritingRTS FAILED ') 
 910    Continue
