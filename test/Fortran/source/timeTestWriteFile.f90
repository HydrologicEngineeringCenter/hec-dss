      SUBROUTINE timeTestWriteFile(dssDir, testFileName, hashSize, binSize, messageUnit, status)

       implicit none
!      
      integer messageUnit, status, hashSize, binSize 
      integer(8) ifltabTo(600)
      ...
      call timeTestWrite(ifltabTo, pathsFileName, messageUnit, status)
