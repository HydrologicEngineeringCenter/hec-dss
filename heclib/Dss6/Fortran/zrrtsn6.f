      SUBROUTINE zrrtsn6 (IFLTAB, CPATH, CDATE, CTIME, NVALS,
     * LGETDOB, VALUES, JQUAL, LQUAL,
     * CUNITS, CTYPE, iuhead, maxUhead, nuhead, IOFSET,
...
C
     ...
     * LGETDOB, LFILDOB, VALUES, VALUES, JQUAL, LQUAL, LQREAD,
     * CUNITS, CTYPE, iuhead, maxUhead, nuhead, IOFSET, JCOMP,
