...
//	}
   ...
   zdssVals.infoSize = zdssInfoKeys.kinfoPathname - zdssInfoKeys.kinfoFlag;
	...
	zfunctionmap.message_group[0]                                    = MESS_METHOD_UNDEFINED_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zopen_ID]                = MESS_METHOD_OPEN_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zclose_ID]               = MESS_METHOD_OPEN_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zset_ID]                 = MESS_METHOD_PUT_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zget_ID]                 = MESS_METHOD_GET_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zput_ID]                 = MESS_METHOD_PUT_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zgetBuff_ID]             = MESS_METHOD_GET_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zputBuff_ID]             = MESS_METHOD_PUT_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zmemoryGet_ID]           = MESS_METHOD_GET_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zmemoryFree_ID]          = MESS_METHOD_GENERAL_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zreadDisk_ID]            = MESS_METHOD_READ_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zwriteDisk_ID]           = MESS_METHOD_WRITE_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zpermRead_ID]            = MESS_METHOD_PERM_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zpermCreate_ID]          = MESS_METHOD_PERM_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zpermWrite_ID]           = MESS_METHOD_PERM_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zwriteEOF_ID]            = MESS_METHOD_WRITE_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zinit_ID]                = MESS_METHOD_GENERAL_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zinitIfltab_ID]          = MESS_METHOD_GENERAL_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zlocking_ID]             = MESS_METHOD_LOCKING_ID;
	zfunctionmap.message_group[DSS_FUNCTION_znewFileSize_ID]         = MESS_METHOD_GENERAL_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zgetFileSpace_ID]        = MESS_METHOD_GENERAL_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zcheckKeys_ID]           = MESS_METHOD_CHECK_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zflushToDisk_ID]         = MESS_METHOD_WRITE_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zhash_ID]                = MESS_METHOD_GENERAL_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zcheck_ID]               = MESS_METHOD_CHECK_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zreadInfo_ID]            = MESS_METHOD_READ_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zcheckMultiUser_ID]      = MESS_METHOD_CHECK_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zreadInternal_ID]        = MESS_METHOD_READ_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zwriteInternal_ID]       = MESS_METHOD_WRITE_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zwriteNew_ID]            = MESS_METHOD_WRITE_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zwriteExisting_ID]       = MESS_METHOD_WRITE_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zbinNew_ID]              = MESS_METHOD_GENERAL_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zbinUpdate_ID]           = MESS_METHOD_GENERAL_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zsetFile_ID]             = MESS_METHOD_GENERAL_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zquery_ID]               = MESS_METHOD_GENERAL_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zdelete_ID]              = MESS_METHOD_GENERAL_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zundelete_ID]            = MESS_METHOD_GENERAL_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zcopyFile_ID]            = MESS_METHOD_COPY_ID;
	zfunctionmap.message_group[DSS_FUNCTION_ztsStoreReg_ID]          = MESS_METHOD_TS_WRITE_ID;
	zfunctionmap.message_group[DSS_FUNCTION_ztsRegStoreBlock_ID]     = MESS_METHOD_TS_WRITE_ID;
	zfunctionmap.message_group[DSS_FUNCTION_ztsStore_ID]             = MESS_METHOD_TS_WRITE_ID;
	zfunctionmap.message_group[DSS_FUNCTION_ztsRetrieve_ID]          = MESS_METHOD_TS_READ_ID;
	zfunctionmap.message_group[DSS_FUNCTION_ztsRetrieveReg_ID]       = MESS_METHOD_TS_READ_ID;
	zfunctionmap.message_group[DSS_FUNCTION_ztsRegReadBlock_ID]      = MESS_METHOD_TS_READ_ID;
	zfunctionmap.message_group[DSS_FUNCTION_ztsWriteBlock_ID]        = MESS_METHOD_TS_WRITE_ID;
	zfunctionmap.message_group[DSS_FUNCTION_ztsTrim_ID]              = MESS_METHOD_GENERAL_ID;
	zfunctionmap.message_group[DSS_FUNCTION_ztsStoreIrreg_ID]        = MESS_METHOD_TS_WRITE_ID;
	zfunctionmap.message_group[DSS_FUNCTION_ztsIrregReadBlock_ID]    = MESS_METHOD_TS_READ_ID;
	zfunctionmap.message_group[DSS_FUNCTION_ztsIrregMergeBlocks_ID]  = MESS_METHOD_GENERAL_ID;
	zfunctionmap.message_group[DSS_FUNCTION_ztsRetrieveIrreg_ID]     = MESS_METHOD_TS_READ_ID;
	zfunctionmap.message_group[DSS_FUNCTION_ztsIrregStoreBlock_ID]   = MESS_METHOD_TS_WRITE_ID;
	zfunctionmap.message_group[DSS_FUNCTION_ztsProcessTimes_ID]      = MESS_METHOD_GENERAL_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zcatalog_ID]             = MESS_METHOD_CATALOG_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zpdStore_ID]             = MESS_METHOD_WRITE_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zpdRetrieve_ID]          = MESS_METHOD_READ_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zinquire_ID]             = MESS_METHOD_GENERAL_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zsqueeze_ID]             = MESS_METHOD_UTILITY_ID;
	zfunctionmap.message_group[DSS_FUNCTION_ztextStore_ID]           = MESS_METHOD_WRITE_ID;
	zfunctionmap.message_group[DSS_FUNCTION_ztextRetrieve_ID]        = MESS_METHOD_READ_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zcopyRecord_ID]          = MESS_METHOD_COPY_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zrename_ID]              = MESS_METHOD_UTILITY_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zduplicateRecord_ID]     = MESS_METHOD_COPY_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zarrayRetrieve_ID]       = MESS_METHOD_READ_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zarrayStore_ID]          = MESS_METHOD_WRITE_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zbinaryStore_ID]         = MESS_METHOD_WRITE_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zbinaryRetrieve_ID]      = MESS_METHOD_READ_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zcheckHashTable_ID]      = MESS_METHOD_FILE_CHECK_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zcheckInfo_ID]           = MESS_METHOD_FILE_CHECK_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zcheckLinks_ID]          = MESS_METHOD_FILE_CHECK_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zcheckPathnameBins_ID]   = MESS_METHOD_FILE_CHECK_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zcheckPathnames_ID]      = MESS_METHOD_FILE_CHECK_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zspatialTinStore_ID]     = MESS_METHOD_WRITE_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zspatialTinRetrieve_ID]  = MESS_METHOD_READ_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zaliasAdd_ID]            = MESS_METHOD_ALIAS_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zaliasRemove_ID]         = MESS_METHOD_ALIAS_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zaliasUtil_ID]           = MESS_METHOD_ALIAS_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zlocationStore_ID]       = MESS_METHOD_WRITE_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zlocationRetrieve_ID]    = MESS_METHOD_READ_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zread_ID]                = MESS_METHOD_READ_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zwrite_ID]               = MESS_METHOD_WRITE_ID;
	zfunctionmap.message_group[DSS_FUNCTION_internalUtility_ID]      = MESS_METHOD_UTILITY_ID;
	zfunctionmap.message_group[DSS_FUNCTION_ztsAggregate_ID]         = MESS_METHOD_GENERAL_ID;
	zfunctionmap.message_group[DSS_FUNCTION_ztsDisaggregate_ID]      = MESS_METHOD_GENERAL_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zspatialGridStore_ID]    = MESS_METHOD_WRITE_ID;
	zfunctionmap.message_group[DSS_FUNCTION_zspatialGridRetrieve_ID] = MESS_METHOD_READ_ID;
	zfunctionmap.message_group[DSS_FUNCTION_other_ID]                = MESS_METHOD_UNDEFINED_ID;
