...
/**
*  Function:	zstructPdNewDoubles
*
*  Use:			Public
*
*  Description:	Creates a new paired data struct with data for storing a paired data double data set.
*
*  Declaration: zstructPdNewDoubles(const char* pathname, double *doubleOrdinates, double *doubleValues,
...
*					The ordinate array containing the data to store.  Must be numberOrdinates long
*
*				double *doubleValues
*					The curves array containing the data to store.  Must be numberCurves * numberOrdinates long.
*					The nominal dimension is doubleValues[numberCurves][numberOrdinates]
									   ...
									   const char *unitsDependent, const char *typeDependent)
{
	...
	pds->doubleOrdinates = doubleOrdinates;
	pds->doubleValues = doubleValues;
