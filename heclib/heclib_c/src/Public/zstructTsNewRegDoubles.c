...
/**
*  Function:	zstructTsNewRegDoubles
*
*  Use:			Public
*
*  Description:	Creates a new time series struct with data for storing a regular-interval double data set.
*
*  Declaration: zStructTimeSeries* zstructTsNewRegDoubles(const char* pathname, double *doubleValues, int numberValues,
