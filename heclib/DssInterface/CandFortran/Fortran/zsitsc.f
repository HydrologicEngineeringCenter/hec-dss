      SUBROUTINE zsitsc7(IFLTAB, CPATH, ITIMES,  VALUES, DVALUES,
...
C
C
      CALL zsitsi7(IFLTAB, CPATH, ITIMES, VALUES, DVALUES,
     * LDOUBLE, NVALUE, IBDATE, JQUAL, LSQUAL, CUNITS, CTYPE,
