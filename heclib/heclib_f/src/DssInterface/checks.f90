...
!           Allow different case strings
 ...
 100 continue
    ...
    subroutine checkTimes(dataOrig, dataRead, baseDate, timeGranularityFlag, number, mess, status)
    ...
    integer i, minutesInBaseDate, baseDate, timeRead, timeGranularityFlag
