      SUBROUTINE zofset7 (JULIAN, ktime, intl, IFLAG, kofset)
C
      implicit none
      integer julian,ktime,iflag,kofset
      integer iofset,jul,jofset
      integer itemp,kday,idaywk,jliymd,jday,jmon
      integer idum,iyear,imon,iday,jyear,iymdjl,inctim
C
C
...
C
C
      integer jtime, itime, interval, intl
