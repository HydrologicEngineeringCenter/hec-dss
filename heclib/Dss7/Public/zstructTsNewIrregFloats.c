...
/**
*  Function:	zstructTsNewIrregFloats
*
*  Use:			Public
*
*  Description:	Creates a new time series struct with data for storing a irregular-interval float data set.
*					Note:  For STORING data only.
*
*  Declaration: zstructTsNewIrregFloats(const char* pathname, float *floatValues, int numberValues,
